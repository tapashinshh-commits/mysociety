        ...
        {success ? (
          ...
          <div className="rounded-xl border border-border bg-surface p-8 text-center">
            ...
            <p className="mb-6 text-sm text-muted">
              ...
              Click the link to verify your account and start using MySociety.
            </p>
            <a
              href="/auth"
          ...
          <div className="rounded-xl border border-border bg-surface p-8">
            ...
            <p className="mb-6 text-sm text-muted">
              Join your society community today.
            </p>
              ...
              <div className="mb-3">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-border bg-background py-3 pl-10 pr-10 text-sm text-foreground placeholder:text-muted focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                  />
                  <button
                    type="button"
